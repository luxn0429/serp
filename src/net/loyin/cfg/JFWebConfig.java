...
//		me.setMainRenderFactory(new HttlRenderFactory());
		/**无权限访问时，跳转到登录!*/
		me.setErrorView(401,"/app/login.html");
		me.setErrorView(403,"/app/login.html");
		me.setError404View("/app/err404.html");
		me.setError500View("/app/err500.html");
...
//		me.add(new OperateLogInterceptor());//日志记录
	...
	public void configHandler(Handlers me) {
	  ...
	  //该处理器将request.getContextPath()存储在root中，可以解决路径问题
	  	...
	  	me.add(path);
	  	me.add(new FakeStaticHandler(".html"));//伪静态.html
